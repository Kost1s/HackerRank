...
public class MergeSortPrinceton {
    ...
    private static void sort(Comparable[] a, Comparable[] aux, int lo, int hi) {
        ...
        System.out.println("before left sort" + " lo: " + lo + " mid: " + mid + " hi " + hi);
        sort(a, aux, lo, mid);

        System.out.println("before right sort" + " lo: " + lo + " mid: " + mid + " hi " + hi);
        sort(a, aux, mid + 1, hi);

        System.out.println("before merge" + " lo: " + lo + " mid: " + mid + " hi " + hi);
